...
(function ($) {
    ...
    */
    ...
    $.fn.timesetter = function (options) {
        ...
        if (wrapper.find(".divTimeSetterContainer").length !== 1) {
            switch ($.fn.settings.ui_ver) {
                case 1:
                    wrapper.html(htmlTemplate_1);
                    break;
                case 2:
                    wrapper.html(htmlTemplate_2);
                    break;
                default:
    ...
    function updateTimeValue(sender) {
        ...
        if ($.fn.settings.ui_ver == 1 || $.fn.settings.ui_ver == 2) {
     ...
     */
    var htmlTemplate_0 = '<div class="divTimeSetterContainer">' + '<div class="timeValueBorder">' + '<input type="text" class="timePart hours txtHours" data-unit="hours" autocomplete="off" />' + '<span class="hourSymbol"></span>' + '<span class="timeDelimiter">:</span>' + '<input type="text" class="timePart minutes txtMinutes" data-unit="minutes" autocomplete="off" />' + '<span class="minuteSymbol"></span>' + '<div class="button-time-control">' + '<div type="button" data-direction="increment" class="updownButton btnUp">' + '<i class="glyphicon glyphicon-triangle-top"></i>' + '</div>' + '<div type="button" data-direction="decrement" class="updownButton btnDown">' + '<i class="glyphicon glyphicon-triangle-bottom"></i>' + '</div>' + '</div>' + '</div>' + '<label class="postfix-position"></label>' + '</div>';

    /**
     *  UI template ver 1
     */
    var htmlTemplate_1 = '<div class="divTimeSetterContainer ui-ver-1">' + '<div class="timeValueBorder">' + '<input type="text" class="timePart hours txtHours" data-unit="hours" autocomplete="off">' + '<span class="hourSymbol">hrs</span>' + '<div class="button-time-control">' + '<div type="button" data-direction="increment" class="updownButton btnUp" data-unit="hours">' + '<i class="glyphicon glyphicon-triangle-top"></i>' + '</div>' + '<div type="button" data-direction="decrement" class="updownButton btnDown" data-unit="hours">' + '<i class="glyphicon glyphicon-triangle-bottom"></i>' + ' </div>' + '</div>' + '</div>' + '<span class="timeDelimiter">&nbsp;</span>' + '<div class="timeValueBorder">' + '<input type="text" class="timePart minutes txtMinutes" data-unit="minutes" autocomplete="off">' + '<span class="minuteSymbol">mins</span>' + '<div class="button-time-control">' + '<div type="button" data-direction="increment" class="updownButton btnUp" data-unit="minutes">' + '<i class="glyphicon glyphicon-triangle-top"></i>' + '</div>' + '<div type="button" data-direction="decrement" class="updownButton btnDown" data-unit="minutes">' + '<i class="glyphicon glyphicon-triangle-bottom"></i>' + '</div>' + '</div>' + '</div>' + '<label class="postfix-position"></label>' + '</div>';
    /**
     * UI template ver 2
     */
    var htmlTemplate_2 = '<div class="divTimeSetterContainer ui-ver-2">' + '<div class="button-time-control">' + '<div type="button" data-direction="increment" class="updownButton btnUp" data-unit="hours">' + '<i class="glyphicon glyphicon-triangle-top"></i>' + '</div>' + '</div>' + '<div class="timeValueBorder">' + '<input type="text" class="timePart hours txtHours" data-unit="hours" autocomplete="off">' + '</div>' + '<div class="button-time-control">' + '<div type="button" data-direction="decrement" class="updownButton btnDown" data-unit="hours">' + '<i class="glyphicon glyphicon-triangle-bottom"></i>' + ' </div>' + '</div>' + '<span class="timeDelimiter">:</span>' + '<div class="button-time-control">' + '<div type="button" data-direction="increment" class="updownButton btnUp" data-unit="minutes">' + '<i class="glyphicon glyphicon-triangle-top"></i>' + '</div>' + '</div>' + '<div class="timeValueBorder">' + '<input type="text" class="timePart minutes txtMinutes" data-unit="minutes" autocomplete="off">' + '</div>' + '<div class="button-time-control">' + '<div type="button" data-direction="decrement" class="updownButton btnDown" data-unit="minutes">' + '<i class="glyphicon glyphicon-triangle-bottom"></i>' + '</div>' + '</div>' + '<label class="postfix-position"></label>' + '</div>';
})(jQuery);
